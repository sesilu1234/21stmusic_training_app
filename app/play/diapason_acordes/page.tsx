...
const opciones = [
  {
    title: "Triadas",
    description: "Reconoce acordes mayores, menores, aumentados y disminuidos en el diapasón.",
    href: "/play/acordes/diapason_triadas",
  },
  {
    title: "Séptimas",
    description: "Practica acordes Mayor 7, Menor 7, Dominante 7 y Semidisminuido.",
          ...
          {opciones.map((opcion) => (
            ...
            >
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-400/15">
                <Music2 className="text-emerald-300" size={28} />
              </div>
