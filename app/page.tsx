...
const juegos: Juego[] = [
  ...
  { id: 9, titulo: "Oído", desc: "Entrena tu oído: intervalos melódicos, armónicos y dobles díadas.", icon: Headphones, bg: "bg-violet-500/20", accent: "text-violet-400", slug: "/play/oido" },
];
